This package is a fork from https://github.com/tonerdo/coverlet for the purposes to automate and build an unofficial, as is NuGet package for people who want to expiriment.
